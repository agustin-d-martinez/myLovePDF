...
from widgets import (AnimatedButton, ButtonListWidget, DroppableLineEdit, ImageLabel,
    ModernCheckBox)
import res_rc_rc
...
class Ui_MyLovePDF(object):
    def setupUi(self, MyLovePDF):
        ...
        self.centralwidget.setStyleSheet(u"QWidget#centralwidget{background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0.133333 rgba(53, 53, 53, 255), stop:1 rgba(0, 0, 0, 255));}\n"
...
"QTabWidget#tabWidget"
                        "MSC::pane {background: transparent;border: none;border-image: url(':/resources/resources/bgMSC3.png') 0 0 0 0 stretch}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1111, 1178))
        ...
        self.pushButtonPDFmini = AnimatedButton(self.widget)
        self.pushButtonPDFmini.setObjectName(u"pushButtonPDFmini")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.pushButtonPDFmini.sizePolicy().hasHeightForWidth())
        self.pushButtonPDFmini.setSizePolicy(sizePolicy1)
        self.pushButtonPDFmini.setMinimumSize(QSize(68, 85))
        self.pushButtonPDFmini.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.pushButtonIMGmini = AnimatedButton(self.widget)
        self.pushButtonIMGmini.setObjectName(u"pushButtonIMGmini")
        sizePolicy1.setHeightForWidth(self.pushButtonIMGmini.sizePolicy().hasHeightForWidth())
        self.pushButtonIMGmini.setSizePolicy(sizePolicy1)
        self.pushButtonIMGmini.setMinimumSize(QSize(68, 85))
        self.pushButtonIMGmini.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.pushButtonFILEmini = AnimatedButton(self.widget)
        self.pushButtonFILEmini.setObjectName(u"pushButtonFILEmini")
        sizePolicy1.setHeightForWidth(self.pushButtonFILEmini.sizePolicy().hasHeightForWidth())
        self.pushButtonFILEmini.setSizePolicy(sizePolicy1)
        self.pushButtonFILEmini.setMinimumSize(QSize(68, 85))
        self.pushButtonFILEmini.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.pushButtonMSCmini = AnimatedButton(self.widget)
        self.pushButtonMSCmini.setObjectName(u"pushButtonMSCmini")
        sizePolicy1.setHeightForWidth(self.pushButtonMSCmini.sizePolicy().hasHeightForWidth())
        self.pushButtonMSCmini.setSizePolicy(sizePolicy1)
        self.pushButtonMSCmini.setMinimumSize(QSize(68, 85))
        self.pushButtonMSCmini.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        sizePolicy2.setHeightForWidth(self.widgetPDF.sizePolicy().hasHeightForWidth())
        self.widgetPDF.setSizePolicy(sizePolicy2)
        self.widgetPDF.setMinimumSize(QSize(960, 0))
        self.widgetPDF.setMaximumSize(QSize(16777215, 300))
        ...
        sizePolicy3.setHeightForWidth(self.pushButtonPDF.sizePolicy().hasHeightForWidth())
        self.pushButtonPDF.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.tabWidgetPDF.sizePolicy().hasHeightForWidth())
        self.tabWidgetPDF.setSizePolicy(sizePolicy4)
        self.tabWidgetPDF.setMinimumSize(QSize(1020, 0))
        self.tabWidgetPDF.setMaximumSize(QSize(16777215, 16777215))
...
"QLabel{background-color: transparent;padding:2px;border-bottom: 4px solid #540c0c;color:white;}")
        ...
        self.horizontalSpacer_14 = QSpacerItem(10000, 17, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;}")
        ...
        sizePolicy6.setHeightForWidth(self.ListFileSelector.sizePolicy().hasHeightForWidth())
        self.ListFileSelector.setSizePolicy(sizePolicy6)
        ...
        self.horizontalSpacer_9 = QSpacerItem(120, 13, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
        ...
        self.label_2.setMinimumSize(QSize(145, 19))
...
"")
        ...
        self.label.setMinimumSize(QSize(20, 19))
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy7.setHeightForWidth(self.HojasSeparar.sizePolicy().hasHeightForWidth())
        self.HojasSeparar.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.NombreExtra.sizePolicy().hasHeightForWidth())
        self.NombreExtra.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.FileSelector_2.sizePolicy().hasHeightForWidth())
        self.FileSelector_2.setSizePolicy(sizePolicy7)
...
"")
        ...
        self.checkBoxConsevar.setMinimumSize(QSize(135, 24))
        self.checkBoxConsevar.setMaximumSize(QSize(16777215, 24))
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        self.horizontalSpacer_8 = QSpacerItem(1000, 177, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        sizePolicy8.setHeightForWidth(self.checkBoxSplitAll.sizePolicy().hasHeightForWidth())
        self.checkBoxSplitAll.setSizePolicy(sizePolicy8)
        self.checkBoxSplitAll.setMinimumSize(QSize(135, 24))
        self.checkBoxSplitAll.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_6.addWidget(self.checkBoxSplitAll, 4, 3, 1, 1)

        self.horizontalSpacer_5 = QSpacerItem(10000, 68, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        sizePolicy7.setHeightForWidth(self.HojasSeparar_3.sizePolicy().hasHeightForWidth())
        self.HojasSeparar_3.setSizePolicy(sizePolicy7)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy7.setHeightForWidth(self.FileSelector_3.sizePolicy().hasHeightForWidth())
        self.FileSelector_3.setSizePolicy(sizePolicy7)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy7.setHeightForWidth(self.FileSelector_4.sizePolicy().hasHeightForWidth())
        self.FileSelector_4.setSizePolicy(sizePolicy7)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        self.horizontalSpacer_2 = QSpacerItem(10000, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        sizePolicy7.setHeightForWidth(self.HojasSeparar_2.sizePolicy().hasHeightForWidth())
        self.HojasSeparar_2.setSizePolicy(sizePolicy7)
...
"")
        ...
        self.widgetIMG.setMaximumSize(QSize(16777215, 300))
        ...
        sizePolicy3.setHeightForWidth(self.pushButtonIMG.sizePolicy().hasHeightForWidth())
        self.pushButtonIMG.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.tabWidgetIMG.sizePolicy().hasHeightForWidth())
        self.tabWidgetIMG.setSizePolicy(sizePolicy4)
        self.tabWidgetIMG.setMinimumSize(QSize(1020, 0))
        self.tabWidgetIMG.setMaximumSize(QSize(16777215, 16777215))
        self.tabWidgetIMG.setBaseSize(QSize(1100, 0))
        self.tabWidgetIMG.setStyleSheet(u"QTabBar::tab {background:#0c1d68;padding: 4px;border-top-left-radius: 5px;border-top-right-radius: 5px;color:white;}\n"
...
"border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;}")
        ...
        sizePolicy9.setHeightForWidth(self.ListFileSelector_2.sizePolicy().hasHeightForWidth())
        self.ListFileSelector_2.setSizePolicy(sizePolicy9)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        self.horizontalSpacer_10 = QSpacerItem(100, 20, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_12 = QSpacerItem(1000, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy10.setHeightForWidth(self.ButtonFileSelect_6.sizePolicy().hasHeightForWidth())
        self.ButtonFileSelect_6.setSizePolicy(sizePolicy10)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        sizePolicy6.setHeightForWidth(self.SaveButton_6.sizePolicy().hasHeightForWidth())
        self.SaveButton_6.setSizePolicy(sizePolicy6)
...
"")
        ...
        self.horizontalSpacer_11 = QSpacerItem(10000, 100, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;}")
        ...
        sizePolicy9.setHeightForWidth(self.ListFileSelector_3.sizePolicy().hasHeightForWidth())
        self.ListFileSelector_3.setSizePolicy(sizePolicy9)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy7.setHeightForWidth(self.FileSelector_8.sizePolicy().hasHeightForWidth())
        self.FileSelector_8.setSizePolicy(sizePolicy7)
...
"QPushButton:pressed{border-color: #05051a;background-color: darkgrey}")
        ...
        self.horizontalSpacer_20 = QSpacerItem(150, 20, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)
        ...
        self.horizontalSpacer_21 = QSpacerItem(10000, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        ...
        sizePolicy6.setHeightForWidth(self.SaveButton_9.sizePolicy().hasHeightForWidth())
        self.SaveButton_9.setSizePolicy(sizePolicy6)
...
"")
        ...
        self.widgetFILE.setMaximumSize(QSize(16777215, 300))
        ...
        sizePolicy11.setHeightForWidth(self.pushButtonFILE.sizePolicy().hasHeightForWidth())
        self.pushButtonFILE.setSizePolicy(sizePolicy11)
        ...
        sizePolicy4.setHeightForWidth(self.tabWidgetFILE.sizePolicy().hasHeightForWidth())
        self.tabWidgetFILE.setSizePolicy(sizePolicy4)
        self.tabWidgetFILE.setMinimumSize(QSize(1020, 0))
        self.tabWidgetFILE.setMaximumSize(QSize(16777215, 16777215))
...
"")
        ...
        self.horizontalSpacer_4 = QSpacerItem(70, 20, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)
...
"border-bottom-left-radius: 10px;border-bottom-right-radius: 10px;}")
        ...
        sizePolicy13 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        sizePolicy13.setHorizontalStretch(0)
        sizePolicy13.setVerticalStretch(75)
        sizePolicy13.setHeightForWidth(self.ListFileSelector_4.sizePolicy().hasHeightForWidth())
        self.ListFileSelector_4.setSizePolicy(sizePolicy13)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        self.gridLayout_2.addWidget(self.toolButton_3, 0, 6, 1, 1)
...
"QPushButton:pressed{border-color: #020224;background-color: darkgrey}")
        ...
        self.label_15.setMinimumSize(QSize(20, 19))
...
"")
        ...
        self.label_14.setMinimumSize(QSize(20, 19))
        ...
        self.label_13.setMinimumSize(QSize(20, 19))
        ...
        sizePolicy7.setHeightForWidth(self.NameTemplate.sizePolicy().hasHeightForWidth())
        self.NameTemplate.setSizePolicy(sizePolicy7)
        self.NameTemplate.setMaximumSize(QSize(170, 16777215))

        self.gridLayout_2.addWidget(self.NameTemplate, 1, 3, 1, 1)

        self.horizontalSpacer_26 = QSpacerItem(1000, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_2.addItem(self.horizontalSpacer_26, 1, 4, 1, 1)
        ...
        self.widgetMSC.setMaximumSize(QSize(16777215, 16777215))
        ...
        sizePolicy11.setHeightForWidth(self.pushButtonMSC.sizePolicy().hasHeightForWidth())
        self.pushButtonMSC.setSizePolicy(sizePolicy11)
        ...
        sizePolicy4.setHeightForWidth(self.tabWidgetMSC.sizePolicy().hasHeightForWidth())
        self.tabWidgetMSC.setSizePolicy(sizePolicy4)
        self.tabWidgetMSC.setMinimumSize(QSize(1020, 0))
        self.tabWidgetMSC.setMaximumSize(QSize(16777215, 16777215))
...
"QLabel{background-color: transparent;padding:2px;color:white;border-bottom: 4px solid #1a5410;}")
        ...
        self.gridLayout_9.setContentsMargins(12, 15, -1, 12)
        ...
        self.horizontalSpacer_17 = QSpacerItem(1000, 17, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy8.setHeightForWidth(self.lineEditMusicFolder.sizePolicy().hasHeightForWidth())
        self.lineEditMusicFolder.setSizePolicy(sizePolicy8)
...
"QPushButton:pressed{border-color: #0a1f06;background-color: darkgrey}")
        ...
        sizePolicy14.setHeightForWidth(self.WidgetMusicTag.sizePolicy().hasHeightForWidth())
        self.WidgetMusicTag.setSizePolicy(sizePolicy14)
        ...
        self.lineEditCompositor.setMaximumSize(QSize(16777215, 24))
        ...
        sizePolicy5.setHeightForWidth(self.labelCover.sizePolicy().hasHeightForWidth())
        self.labelCover.setSizePolicy(sizePolicy5)
        ...
        self.label_17.setMinimumSize(QSize(0, 19))
        ...
        self.lineEditInterpeter.setMaximumSize(QSize(16777215, 24))
        ...
        self.comboBoxGenre.setMaximumSize(QSize(16777215, 24))
        ...
        self.label_18.setMinimumSize(QSize(0, 19))
        ...
        self.label_20.setMinimumSize(QSize(0, 19))
        ...
        self.lineEditAlbum.setMaximumSize(QSize(16777215, 24))
        ...
        self.lineEditMood.setMaximumSize(QSize(16777215, 24))
        ...
        self.lineEditYear.setMaximumSize(QSize(100, 24))
        ...
        self.lineEditAlbumInter.setMaximumSize(QSize(16777215, 24))
        ...
        self.spinBoxTrack.setMaximumSize(QSize(16777215, 24))
        ...
        self.label_25.setMaximumSize(QSize(16777215, 24))
        ...
        self.spinBoxMaxTrack.setMaximumSize(QSize(16777215, 24))
        ...
        self.verticalSpacer_7 = QSpacerItem(38, 10, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout_8.addItem(self.verticalSpacer_7, 7, 1, 1, 3)

        self.verticalSpacer_8 = QSpacerItem(38, 10, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        self.verticalSpacer_10 = QSpacerItem(15, 15, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.MinimumExpanding)
        ...
        sizePolicy4.setHeightForWidth(self.TextEditLiryc.sizePolicy().hasHeightForWidth())
        self.TextEditLiryc.setSizePolicy(sizePolicy4)
        self.TextEditLiryc.setMinimumSize(QSize(572, 75))
        ...
        self.horizontalSpacer_18 = QSpacerItem(100, 157, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)
        ...
        sizePolicy15 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.MinimumExpanding)
        sizePolicy15.setHorizontalStretch(0)
        sizePolicy15.setVerticalStretch(0)
        sizePolicy15.setHeightForWidth(self.listWidgetMusic.sizePolicy().hasHeightForWidth())
        self.listWidgetMusic.setSizePolicy(sizePolicy15)
        ...
        self.SaveButton_8.setMinimumSize(QSize(0, 20))
...
"")
        ...
        self.gridLayout_9.addWidget(self.SaveButton_8, 6, 0, 1, 5)
        ...
        self.gridLayout_11.setContentsMargins(12, 15, 12, -1)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        sizePolicy7.setHeightForWidth(self.FileSelector_9.sizePolicy().hasHeightForWidth())
        self.FileSelector_9.setSizePolicy(sizePolicy7)
...
"QPushButton:pressed{border-color: #05051a;background-color: darkgrey}")
        ...
        self.horizontalSpacer_22 = QSpacerItem(1000, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
"")
        ...
        self.gridLayout_12 = QGridLayout(self.tabYoutube)
        self.gridLayout_12.setObjectName(u"gridLayout_12")
        self.gridLayout_12.setHorizontalSpacing(0)
        self.gridLayout_12.setContentsMargins(12, 15, -1, 12)
...
"border: 1px solid #ffffff;padding: 5px;font-size: 10pt;}")
        ...
        self.gridLayout_12.addWidget(self.toolButton_10, 0, 7, 1, 1)

        self.lineEditVideoTitle = QLineEdit(self.tabYoutube)
        self.lineEditVideoTitle.setObjectName(u"lineEditVideoTitle")
        sizePolicy8.setHeightForWidth(self.lineEditVideoTitle.sizePolicy().hasHeightForWidth())
        self.lineEditVideoTitle.setSizePolicy(sizePolicy8)
        self.lineEditVideoTitle.setMinimumSize(QSize(400, 24))
...
"border-radius: 10px;")
        ...
        self.gridLayout_12.addWidget(self.lineEditVideoTitle, 5, 0, 1, 2)
...
"")
        ...
        self.gridLayout_12.addWidget(self.SaveButton_10, 7, 0, 1, 7)

        self.lineEditUrl = QLineEdit(self.tabYoutube)
        self.lineEditUrl.setObjectName(u"lineEditUrl")
        sizePolicy8.setHeightForWidth(self.lineEditUrl.sizePolicy().hasHeightForWidth())
        self.lineEditUrl.setSizePolicy(sizePolicy8)
        self.lineEditUrl.setMinimumSize(QSize(400, 24))
...
"border-radius: 10px;")
        ...
        self.gridLayout_12.addWidget(self.lineEditUrl, 1, 0, 1, 2)

        self.label_36 = QLabel(self.tabYoutube)
        self.label_36.setObjectName(u"label_36")
        sizePolicy5.setHeightForWidth(self.label_36.sizePolicy().hasHeightForWidth())
        self.label_36.setSizePolicy(sizePolicy5)
        self.label_36.setMinimumSize(QSize(0, 19))
        self.label_36.setMaximumSize(QSize(16777215, 19))

        self.gridLayout_12.addWidget(self.label_36, 4, 3, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.label_32, 0, 0, 1, 2)
        ...
        self.gridLayout_12.addWidget(self.label_34, 4, 0, 1, 2)

        self.comboBoxResolution = QComboBox(self.tabYoutube)
        ...
        self.comboBoxResolution.setMinimumSize(QSize(0, 24))
        self.comboBoxResolution.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_12.addWidget(self.comboBoxResolution, 5, 3, 1, 1)

        self.labelThumbnail = QLabel(self.tabYoutube)
        self.labelThumbnail.setObjectName(u"labelThumbnail")
        sizePolicy5.setHeightForWidth(self.labelThumbnail.sizePolicy().hasHeightForWidth())
        self.labelThumbnail.setSizePolicy(sizePolicy5)
        self.labelThumbnail.setMinimumSize(QSize(190, 190))
        self.labelThumbnail.setMaximumSize(QSize(190, 190))
        ...
        self.gridLayout_12.addWidget(self.labelThumbnail, 1, 5, 5, 1)
        ...
        self.comboBoxFileType.setMinimumSize(QSize(0, 24))
        self.comboBoxFileType.setMaximumSize(QSize(16777215, 24))

        self.gridLayout_12.addWidget(self.comboBoxFileType, 1, 3, 1, 1)

        self.verticalSpacer_11 = QSpacerItem(20, 96, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_12.addItem(self.verticalSpacer_11, 3, 0, 1, 2)

        self.horizontalSpacer_24 = QSpacerItem(100, 20, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_12.addItem(self.horizontalSpacer_24, 1, 4, 5, 1)

        self.verticalSpacer_12 = QSpacerItem(20, 96, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout_12.addItem(self.verticalSpacer_12, 6, 0, 1, 2)

        self.horizontalSpacer_23 = QSpacerItem(50, 212, QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_12.addItem(self.horizontalSpacer_23, 0, 2, 6, 1)

        self.horizontalSpacer_25 = QSpacerItem(10000, 187, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_12.addItem(self.horizontalSpacer_25, 1, 6, 5, 1)
        ...
        self.verticalSpacer_6 = QSpacerItem(20, 1000, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.lineEditUrl.editingFinished.connect(MyLovePDF.UpdateYoutubeVid)
    ...
    def retranslateUi(self, MyLovePDF):
...
#if QT_CONFIG(tooltip)
        self.toolButton_2.setToolTip(QCoreApplication.translate("MyLovePDF", u"<html><head/><body><p>Convierte los archivos seleccionados en PDF's.</p><p>Deben ser archivos tipo imagen (.jpg, .png, .webp, etc.)</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.comboBox_2.setItemText(2, QCoreApplication.translate("MyLovePDF", u".gif", None))
        self.comboBox_2.setItemText(3, QCoreApplication.translate("MyLovePDF", u".bmp", None))
        self.comboBox_2.setItemText(4, QCoreApplication.translate("MyLovePDF", u".dds", None))
        self.comboBox_2.setItemText(5, QCoreApplication.translate("MyLovePDF", u".ico", None))
        self.comboBox_2.setItemText(6, QCoreApplication.translate("MyLovePDF", u".xbm", None))
...
#if QT_CONFIG(tooltip)
        self.toolButton_8.setToolTip(QCoreApplication.translate("MyLovePDF", u"<html><head/><body><p>Coloca tags a archivos de m\u00fasica (.mp3). Pueden completarse todos los campos o dejar algunos vac\u00edos.</p><p>Los cambios se guardan al presionar &quot;Guardar&quot;</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.toolButton_11.setToolTip(QCoreApplication.translate("MyLovePDF", u"<html><head/><body><p>Transforma el archivo de video seleccionado en un archivo de audio.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.toolButton_10.setToolTip(QCoreApplication.translate("MyLovePDF", u"<html><head/><body><p>Descarga un video seleccionado de Youtube a la computadora. Se descarga con la calidad seleccionada.</p><p>Si la calidad seleccionada no existe, utilizar\u00e1 la m\u00e1s cercana menor.</p><p>El proceso de descarga puede demorar.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.toolButton_10.setWhatsThis(QCoreApplication.translate("MyLovePDF", u"<html><head/><body><p>Descarga el video de Youtube seleccionado en formato mp3 (audio) o mp4 (video) con la resoluci\u00f3n elegida.</p><p>En caso de no tener dicha resoluci\u00f3n buscar\u00e1 la m\u00e1s cercana menor.</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.toolButton_10.setText(QCoreApplication.translate("MyLovePDF", u"...", None))
        self.lineEditVideoTitle.setPlaceholderText("")
        self.SaveButton_10.setText(QCoreApplication.translate("MyLovePDF", u"Descargar", None))
        self.lineEditUrl.setPlaceholderText(QCoreApplication.translate("MyLovePDF", u"https://www.youtube.com/watch?v=XXXXXX", None))
        self.label_36.setText(QCoreApplication.translate("MyLovePDF", u"Resoluci\u00f3n de descarga:", None))
        ...
        self.comboBoxResolution.setItemText(0, QCoreApplication.translate("MyLovePDF", u"1080p", None))
        self.comboBoxResolution.setItemText(1, QCoreApplication.translate("MyLovePDF", u"720p", None))
        self.comboBoxResolution.setItemText(2, QCoreApplication.translate("MyLovePDF", u"480p", None))
        self.comboBoxResolution.setItemText(3, QCoreApplication.translate("MyLovePDF", u"360p", None))
        self.comboBoxResolution.setItemText(4, QCoreApplication.translate("MyLovePDF", u"240p", None))
        self.comboBoxResolution.setItemText(5, QCoreApplication.translate("MyLovePDF", u"144p", None))
